 ...
 *
 */
public class PublisherServerTest {

    private static final Logger LOGGER = LogManager.getLogger(PublisherServerTest.class);

    public int port;
    private boolean started;

    public PublisherServerTest() {
        this.port = 10079;
        this.started= false;
    }
    public PublisherServerTest(int _port) {
        this.port = _port;
        this.started= false;
    }
    ...
    public static void main(String[] args) {
        ...
        PublisherServerTest server = new PublisherServerTest(portNumber.intValue());
